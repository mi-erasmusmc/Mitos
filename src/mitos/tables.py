...
class ConditionOccurrence(Criteria):
    ...
    condition_source_concept: Optional[Union[int, ConceptSetSelection]] = Field(
        None, alias="ConditionSourceConcept"
    )
    age: Optional[NumericRange] = Field(None, alias="Age")
    gender: list[Concept] = Field(default_factory=list, alias="Gender")
    gender_cs: Optional[ConceptSetSelection] = Field(default=None, alias="GenderCS")
    provider_specialty: list[Concept] = Field(
        default_factory=list, alias="ProviderSpecialty"
    )
    ...
    condition_status: list[Concept] = Field(
        default_factory=list, alias="ConditionStatus"
    )
...
class DrugExposure(Criteria):
    ...
    effective_drug_dose: Optional[NumericRange] = Field(
        default=None, alias="EffectiveDrugDose"
    )
...
class VisitOccurrence(Criteria):
    ...
    place_of_service: list[Concept] = Field(
        default_factory=list, alias="PlaceOfService"
    )
...
class Measurement(Criteria):
    ...
    measurement_type: list[Concept] = Field(
        default_factory=list, alias="MeasurementType"
    )
    measurement_type_cs: Optional[ConceptSetSelection] = Field(
        default=None, alias="MeasurementTypeCS"
    )
    measurement_type_exclude: Optional[bool] = Field(
        default=None, alias="MeasurementTypeExclude"
    )
    ...
    value_as_concept: list[Concept] = Field(
        default_factory=list, alias="ValueAsConcept"
    )
    ...
    range_high_ratio: Optional[NumericRange] = Field(
        default=None, alias="RangeHighRatio"
    )
...
class Observation(Criteria):
    ...
    observation_type: list[Concept] = Field(
        default_factory=list, alias="ObservationType"
    )
    observation_type_cs: Optional[ConceptSetSelection] = Field(
        default=None, alias="ObservationTypeCS"
    )
    observation_type_exclude: Optional[bool] = Field(
        default=None, alias="ObservationTypeExclude"
    )
    ...
    observation_source_concept: Optional[int] = Field(
        default=None, alias="ObservationSourceConcept"
    )
...
class ProcedureOccurrence(Criteria):
    ...
    procedure_type_exclude: Optional[bool] = Field(
        default=None, alias="ProcedureTypeExclude"
    )
...
class ObservationPeriod(Criteria):
    ...
    user_defined_period: Optional[UserDefinedPeriod] = Field(
